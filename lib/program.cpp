...
namespace runtime
{
    ...
    Program::Program(VkDevice device, VkPipelineCache pipeline_cache,
                ...
                std::shared_ptr<DescriptorAllocator> &descAllocator, const std::vector<uint32_t> &shader_code,
    ...
    {
        cmd_pool->submitCompute(m_pipeline, m_pipelineLayout, sets.size(), sets.data(), VK_PIPELINE_BIND_POINT_COMPUTE,
